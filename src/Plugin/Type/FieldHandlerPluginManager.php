...
class FieldHandlerPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/drupal_content_sync/field_handler', $namespaces, $module_handler, 'Drupal\drupal_content_sync\Plugin\FieldHandlerInterface', 'Drupal\drupal_content_sync\Annotation\FieldHandler');

    $this->setCacheBackend($cache_backend, 'dcs_field_handler_plugins');
    $this->alterInfo('dcs_field_handler');
  }
