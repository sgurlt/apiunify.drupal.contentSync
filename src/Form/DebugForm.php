...
class DebugForm extends ConfigFormBase {
  ...
  public function inspectEntity($form, FormStateInterface $form_state) {
    ...
    if($entity) {
      ...
      $ajax_response->addCommand(new HtmlCommand('.dcs-inspect-entity-output', $result));
    }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['dcs_inspect_entity']['entity_type'] = [
      '#type' => 'select',
      '#title' => $this->t('Entity type'),
      '#options' => $entity_types_names,
      '#default_value' => 'node',
    ];
    $form['dcs_inspect_entity']['entity_id'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Entity ID'),
    ];
    $form['dcs_inspect_entity']['submit'] = [
      '#type' => 'button',
      '#value' => $this->t('Check'),
      '#ajax' => [
        'callback' => '::inspectEntity',
        'wrapper' => 'dcs-inspect-entity-output',
      ],
    ];
    $form['dcs_inspect_entity']['entity'] = [
      '#prefix' => '<div class="dcs-inspect-entity-output">',
      '#suffix' => '</div>',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('drupal_content_sync.debug')
      ->set('dcs_disable_optimization', $form_state->getValue('dcs_disable_optimization'))
      ->save();
  }
